...
const Team = ()=>{
    return(
        <div className="pb-40">
            ...
            <TeamCard img={img1} name="Ajay Khatri" role="UI/UX Designer & FrontEnd Developer"/>
            <TeamCard img={img3} name="Bipin Ghimire" role="ML/AI Developer"/>
            <TeamCard img={img2} name="Unik Dahal" role="BackEnd Developer"/>
            <TeamCard img={img4} name="Aayush Sinha" role="Documentation"/>
            <TeamCard img={img5} name="Shivam Tripathi" role="Reporting"/>
            </div>
        </div>
    )
}
